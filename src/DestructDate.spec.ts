import { destructJSDate, destructJSDateUTC } from "./DestructDate";
...
describe("utc", () => {
  it("testDate", () => {
    const { year, month, day, hours, minutes, seconds, dweek } = destructJSDateUTC(testDate);
  ...
  it("testDate2", () => {
    const { year, month, day, hours, minutes, seconds, dweek } = destructJSDateUTC(testDate2);
